...
assert 'versionName = "1.0.8"' in version and 'versionCode = 108' in version
...
assert re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.8-arm64-v8a.apk')
assert not re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.8-debug.apk')
report = {
