...
assert 'versionName = "1.0.6"' in version and 'versionCode = 106' in version
...
assert re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.6-arm64-v8a.apk')
assert not re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.6-debug.apk')
report = {
