...
assert 'versionName = "1.0.4"' in version and 'versionCode = 104' in version
...
assert re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.4-arm64-v8a.apk')
assert not re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.4-debug.apk')
report = {
