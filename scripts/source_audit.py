...
assert 'versionName = "1.0.7"' in version and 'versionCode = 107' in version
...
assert re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.7-arm64-v8a.apk')
assert not re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.7-debug.apk')
report = {
