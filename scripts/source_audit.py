...
assert 'versionName = "1.0.0"' in version and 'versionCode = 100' in version
...
assert re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.0-arm64-v8a.apk')
assert not re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.0-debug.apk')
report = {
