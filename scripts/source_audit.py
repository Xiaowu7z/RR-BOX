...
assert 'versionName = "1.0.5"' in version and 'versionCode = 105' in version
...
assert re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.5-arm64-v8a.apk')
assert not re.search(settings['apkFilterRegEx'], 'RRBOX-1.0.5-debug.apk')
report = {
